...
<head>
    ...
    <title>HostApp | RESULTADO DE BÚSQUEDA</title>
</head>
            ...
            @if($place)
                <form action="{{ route('hostal.index') }}" method="GET">
                    <div class="search-res">
                        <div class="search-hab caja-hab">
                            <input class="barra" type="text" name="place" placeholder="Ingresa un destino..." required
                                value="{{ $place }}">
                            <button class="btn-hab" type="submit">
